	...
	<body>
		...
		<div class="swiper-container">
			<div class="swiper-wrapper">
				<div class="swiper-slide"><?=\hl\HLView::img('temp/5.jpg');?></div>
				<div class="swiper-slide"><?=\hl\HLView::img('temp/6.jpg');?></div>
				<div class="swiper-slide"><?=\hl\HLView::img('temp/8.jpg');?></div>
				<div class="swiper-slide"><?=\hl\HLView::img('temp/7.jpg');?></div>
				<div class="swiper-slide"><?=\hl\HLView::img('temp/9.jpg');?></div>
			</div>
		</div>
		<div class="detCon">
			<div class="txt">
				<p>创意白瓷干花花瓶摆件</p>
				<p>【破损补寄】【适合放室内、卧室、书房、餐桌、办公室、客厅、电视柜等地方】【无理由退换货】</p>
				<p>￥39.90</p>
			</div>
			<div class="choice">
				<p class="clearfix buy"><span class="fl">请选择&nbsp;&nbsp;颜色分类</span><i class="iconfont fr">&#xe64b;</i></p>
			</div>
			<div>
				<div class="tit">
					<a href="#" class="on">图文详情</a>
					<a href="#">所有评价</a>
				</div>
				<div class="con">
				...
				<div class="eva">
					...
					<div class="per clearfix">
						<div class="perR fl">
							...
							<p>么***周</p>
							<p>花瓶超级棒，我看图以为是光面的。磨砂上面还有点纹路，不过觉得挺自然的，不影响美观。包装也很好，绝对不会磕碎碰坏，好评！</p>
							<p><span>2016年12月27日08:31</span><span>颜色分类：大中小三件套（不含花）</span></p>
						</div>
					</div>
					<div class="per clearfix">
					...
					<div class="per clearfix">
						<div class="perR fl">
                            <?=\hl\HLView::img('temp/per02.jpg', ['class' => 'fl']);?>
							<p>么***周</p>
							<p>花瓶超级棒，我看图以为是光面的，很喜欢。磨砂上面还有点纹路，不过觉得挺自然的，不影响美观。包装也很好，绝对不会磕碎碰坏，好评！</p>
							<p><span>2016年12月27日08:31</span><span>颜色分类：大中小三件套（不含花）</span></p>
						</div>
					</div>
					<div class="per clearfix">
