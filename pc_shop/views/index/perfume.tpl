...
<html>
	...
	<body>
		...
		<!-----------------banner------------------------------->
		<div class="banner">
			<a href="#"><?=\hl\HLView::img('temp/perfume_Banner.jpg');?></a>
		</div>
		<!-----------------address------------------------------->
		<div class="address">
			<div class="wrapper clearfix">
		...
		<div class="paintCon">
			<section class="wrapper">
				<h3><?=\hl\HLView::img('temp/perfumeTit01.jpg');?></h3>
				<?=\hl\HLView::img('temp/xxB01.jpg');?>
				<div class="paintList">
					<a href="proDetail.html">
						<dl>
							<dt><?=\hl\HLView::img('temp/xx01.jpg');?></dt>
					...
					<a href="proDetail.html">
						<dl>
							<dt><?=\hl\HLView::img('temp/xx02.jpg');?></dt>
							<dd>新中式客厅山水装饰画墙壁挂画 </dd>
							<dd>￥299.90</dd>
						</dl>
					</a>
					<a href="proDetail.html">
						<dl>
							<dt><?=\hl\HLView::img('temp/xx103.jpg');?></dt>
							<dd>新中式客厅山水装饰画墙壁挂画 </dd>
							<dd>￥299.90</dd>
						</dl>
					</a>
					<a href="proDetail.html">
						<dl>
							<dt><?=\hl\HLView::img('temp/xx104.jpg');?></dt>
							<dd>新中式客厅山水装饰画墙壁挂画 </dd>
							<dd>￥299.90</dd>
						</dl>
					</a>
					<a href="proDetail.html">
						<dl>
							<dt><?=\hl\HLView::img('temp/xx105.jpg');?></dt>
							<dd>新中式客厅山水装饰画墙壁挂画 </dd>
							<dd>￥299.90</dd>
						</dl>
					</a>
					<a href="proDetail.html">
						<dl>
							<dt><?=\hl\HLView::img('temp/xx106.jpg');?></dt>
							<dd>新中式客厅山水装饰画墙壁挂画 </dd>
							<dd>￥299.90</dd>
						</dl>
					</a>
			...
			<section class="wrapper">
				<h3><?=\hl\HLView::img('temp/perfumeTit02.jpg');?></h3>
				<?=\hl\HLView::img('temp/xxB02.jpg');?>
				<div class="paintList">
					<a href="proDetail.html">
						<dl>
							<dt><?=\hl\HLView::img('temp/xx201.jpg');?></dt>
							<dd>新中式客厅山水装饰画墙壁挂画 </dd>
							<dd>￥299.90</dd>
						</dl>
					</a>
					<a href="proDetail.html">
						<dl>
							<dt><?=\hl\HLView::img('temp/xx202.jpg');?></dt>
							<dd>新中式客厅山水装饰画墙壁挂画 </dd>
							<dd>￥299.90</dd>
						</dl>
					</a>
					<a href="proDetail.html">
						<dl>
							<dt><?=\hl\HLView::img('temp/xx203.jpg');?></dt>
							<dd>新中式客厅山水装饰画墙壁挂画 </dd>
							<dd>￥299.90</dd>
						</dl>
					</a>
					<a href="proDetail.html">
						<dl>
							<dt><?=\hl\HLView::img('temp/xx204.jpg');?></dt>
							<dd>新中式客厅山水装饰画墙壁挂画 </dd>
							<dd>￥299.90</dd>
						</dl>
					</a>
					<a href="proDetail.html">
						<dl>
							<dt><?=\hl\HLView::img('temp/xx205.jpg');?></dt>
							<dd>新中式客厅山水装饰画墙壁挂画 </dd>
							<dd>￥299.90</dd>
						</dl>
					</a>
					<a href="proDetail.html">
						<dl>
							<dt><?=\hl\HLView::img('temp/xx206.jpg');?></dt>
							<dd>新中式客厅山水装饰画墙壁挂画 </dd>
							<dd>￥299.90</dd>
						</dl>
					</a>
