	...
	<body>
		...
		<ul class="proList wrapper clearfix">
			...
			<li>
				<a href="proDetail.html">
					<dl>
						<dt><?=\hl\HLView::img('temp/vase01.jpg');?></dt>
			...
			<li>
				<a href="proDetail.html">
					<dl>
						<dt><?=\hl\HLView::img('temp/vase02.jpg');?></dt>
			...
			<li>
				<a href="proDetail.html">
					<dl>
						<dt><?=\hl\HLView::img('temp/vase03.jpg');?></dt>
						<dd>【最家】北欧现代陶瓷花瓶摆件</dd>
						<dd>￥17.90</dd>
					</dl>
				</a>
			...
			<li>
				<a href="proDetail.html">
					<dl>
						<dt><?=\hl\HLView::img('temp/vase04.jpg');?></dt>
			...
			<li>
				<a href="proDetail.html">
					<dl>
						<dt><?=\hl\HLView::img('temp/vase05.jpg');?></dt>
			...
			<li>
				<a href="proDetail.html">
					<dl>
						<dt><?=\hl\HLView::img('temp/vase06.jpg');?></dt>
