...
<html>
	...
	<body>
		...
		<div class="thImg">
			<div class="clearfix">
				<a href="vase_proList.html"><?=\hl\HLView::img('i1.jpg');?></a>
				<a href="proList.html"><?=\hl\HLView::img('i2.jpg');?></a>
				<a href="#2"><?=\hl\HLView::img('i3.jpg');?></a>
			</div>
		</div>
		...
		<div class="news">
			<div class="wrapper">
				<h2><?=\hl\HLView::img('ih1.jpg');?></h2>
				<div class="top clearfix">
					<a href="proDetail.html"><?=\hl\HLView::img('n1.jpg');?><p></p></a>
					<a href="proDetail.html"><?=\hl\HLView::img('n2.jpg');?><p></p></a>
					<a href="proDetail.html"><?=\hl\HLView::img('n3.jpg');?><p></p></a>
				</div>
				<div class="bott clearfix">
					<a href="proDetail.html"><?=\hl\HLView::img('n4.jpg');?><p></p></a>
					<a href="proDetail.html"><?=\hl\HLView::img('n5.jpg');?><p></p></a>
					<a href="proDetail.html"><?=\hl\HLView::img('n6.jpg');?><p></p></a>
				</div>
				<h2><?=\hl\HLView::img('ih2.jpg');?></h2>
				<div class="flower clearfix tran">
					<a href="proDetail.html" class="clearfix">
						<dl>
							<dt>
								<span class="abl"></span>
								<?=\hl\HLView::img('flo1.jpg');?>
								<span class="abr"></span>
							</dt>
							<dd>【花艺】七头美丽玫瑰仿真花束</dd>
		...
		<!------------------------------ad------------------------------>
		<a href="#" class="ad"><?=\hl\HLView::img('ib1.jpg');?></a>

		<!------------------------------people------------------------------>
		<div class="people">
			<div class="wrapper">
				<h2><?=\hl\HLView::img('ih3.jpg');?></h2>
				<div class="pList clearfix tran">
					<a href="proDetail.html">
						<dl>
							<dt>
								<span class="abl"></span>
								<?=\hl\HLView::img('s7.jpg');?>
								<span class="abr"></span>
							</dt>
							<dd>【最家】不锈钢壁饰墙饰软装</dd>
