		...
		<div class="order cart mt">
			...
			<div class="site">
				<p class="wrapper clearfix">
					...
					<?=\hl\HLView::img('temp/cartTop02.png', ['class' => 'top']);?>
				</p>
			</div>
			<!-----------------orderCon------------------->
			<div class="orderCon wrapper clearfix">
				<div class="orderL fl">
					...
					<div class="way clearfix">
						<?=\hl\HLView::img('temp/way01.jpg', ['class' => 'on']);?>
						<?=\hl\HLView::img('temp/way02.jpg');?>
						<?=\hl\HLView::img('temp/way03.jpg');?>
						<?=\hl\HLView::img('temp/way04.jpg');?>
					</div>
					<h3>选择快递</h3>
					<!--------dis---------------->
				...
				<div class="orderR fr">
					<div class="msg">
						...
						<ul class="clearfix">
							<li class="fl">
								<?=\hl\HLView::img('temp/order01.jpg');?>
							</li>
							<li class="fl">
								<p>创意现代简约干花花瓶摆件</p>
								<p>颜色分类：烟灰色玻璃瓶</p>
						...
						<ul class="clearfix">
							<li class="fl">
								<?=\hl\HLView::img('temp/order02.jpg');?>
							</li>
							<li class="fl">
								<p>创意现代简约干花花瓶摆件</p>
								<p>颜色分类：烟灰色玻璃瓶</p>
