...
<?=\hl\HLView::publicTpl('header');?>
  <!-- DataTables -->
<?=\hl\HLView::componentsCss('datatables.net-bs/css/dataTables.bootstrap.min.css');?>
<!--引入顶部导航-->
...
<!-- DataTables -->
<?=\hl\HLView::componentsJs('datatables.net/js/jquery.dataTables.min.js');?>
<?=\hl\HLView::componentsJs('datatables.net-bs/js/dataTables.bootstrap.min.js');?>
        <!-- Slimscroll -->
