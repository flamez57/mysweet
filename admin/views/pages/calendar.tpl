...
<?=\hl\HLView::publicTpl('header');?>
  <!-- fullCalendar -->
<?=\hl\HLView::componentsCss('fullcalendar/dist/fullcalendar.min.css');?>
<?=\hl\HLView::componentsCss('fullcalendar/dist/fullcalendar.print.min.css', ['media' => 'print']);?>
...
<!-- fullCalendar -->
<?=\hl\HLView::componentsJs('moment/moment.js');?>
<?=\hl\HLView::componentsJs('fullcalendar/dist/fullcalendar.min.js');?>
