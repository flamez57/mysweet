...
<head>
  ...
  <!-- iCheck -->
  <?=\hl\HLView::pluginsCss('iCheck/square/blue.css');?>
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?=\hl\HLRoute::makeUrl('admin', 'index', 'index')?>"><b>Admin</b>LTE</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your session</p>

    <form action="<?=\hl\HLRoute::makeUrl('admin', 'index', 'index')?>" method="post">
    ...
    <a href="<?=\hl\HLRoute::makeUrl('admin', 'pages', 'register')?>" class="text-center">Register a new membership</a>
