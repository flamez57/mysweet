          ...
          <div class="box box-primary">
            ...
            <div class="box-footer">
              <ul class="mailbox-attachments clearfix">
                ...
                <li>
                  <span class="mailbox-attachment-icon has-img"><?=\hl\HLView::img('photo1.png', ['class' => '', 'alt' => 'Attachment']);?></span>
                ...
                <li>
                  <span class="mailbox-attachment-icon has-img"><?=\hl\HLView::img('photo2.png', ['class' => '', 'alt' => 'Attachment']);?></span>
