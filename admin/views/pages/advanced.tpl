...
<?=\hl\HLView::pluginsCss('iCheck/all.css');?>
  <!-- Bootstrap Color Picker -->
<?=\hl\HLView::componentsCss('bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css');?>
  <!-- Bootstrap time Picker -->
<?=\hl\HLView::pluginsCss('timepicker/bootstrap-timepicker.min.css');?>
  <!-- Select2 -->
<?=\hl\HLView::componentsCss('select2/dist/css/select2.min.css');?>
...
<!-- Select2 -->
<?=\hl\HLView::componentsJs('select2/dist/js/select2.full.min.js');?>
<!-- InputMask -->
<?=\hl\HLView::pluginsJs('input-mask/jquery.inputmask.js');?>
<?=\hl\HLView::pluginsJs('input-mask/jquery.inputmask.date.extensions.js');?>
<?=\hl\HLView::pluginsJs('input-mask/jquery.inputmask.extensions.js');?>
<!-- date-range-picker -->
...
<!-- bootstrap color picker -->
<?=\hl\HLView::componentsJs('bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js');?>
<!-- bootstrap time picker -->
<?=\hl\HLView::pluginsJs('timepicker/bootstrap-timepicker.min.js');?>
<!-- SlimScroll -->
