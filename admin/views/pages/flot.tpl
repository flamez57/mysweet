...
<!-- FLOT CHARTS -->
<?=\hl\HLView::componentsJs('Flot/jquery.flot.js');?>
<!-- FLOT RESIZE PLUGIN - allows the chart to redraw when the window is resized -->
<?=\hl\HLView::componentsJs('Flot/jquery.flot.resize.js');?>
<!-- FLOT PIE PLUGIN - also used to draw donut charts -->
<?=\hl\HLView::componentsJs('Flot/jquery.flot.pie.js');?>
<!-- FLOT CATEGORIES PLUGIN - Used to draw bar charts -->
<?=\hl\HLView::componentsJs('Flot/jquery.flot.categories.js');?>
<!-- Page script -->
<script>
  $(function () {
    /*
